...
public class KoboldFollowOwnerGoal extends Goal {
    ...
    public KoboldFollowOwnerGoal(Kobold pTamable, double pSpeedModifier, float pStartDistance, float pStopDistance, boolean pCanFly) {
    ...
    public boolean canUse() {
        ...
        if (livingentity == null) {
            ...
            return false;
        } else if (this.tamable.isPanicked()) {
            return false;
