...
public class TFEntities {
	...
	public static final EntityType<PlateauBoss> PLATEAU_BOSS = make(TFEntityNames.PLATEAU_BOSS, PlateauBoss::new, MobCategory.MONSTER, 16.0F, 8.0F, true);
	...
	public static void registerEntities(RegistryEvent.Register<EntityType<?>> evt) {
		...
		SpawnPlacements.register(PLATEAU_BOSS, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	...
	public static void registerEntityRenderer(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(PLATEAU_BOSS, FinalBossRenderer::new);
