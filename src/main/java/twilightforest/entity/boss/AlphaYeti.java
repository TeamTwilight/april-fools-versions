...
public class AlphaYeti extends Monster implements RangedAttackMob, IHostileMount, EnforcedHomePoint, iKobold {
	...
	public void die(DamageSource cause) {
		...
		if (!this.getLevel().isClientSide()) {
			...
			Interloper.summonMultiple(this.level, 2, this.blockPosition());
