...
public class PlateauBossPart extends TFPart<PlateauBoss> {

	public final PlateauBoss parentMob;
	public final String name;
	private final EntityDimensions size;

	public PlateauBossPart(PlateauBoss p_31014_, String p_31015_, float p_31016_, float p_31017_) {
		super(p_31014_);
