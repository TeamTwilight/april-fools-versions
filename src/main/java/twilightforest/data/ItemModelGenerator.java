...
public class ItemModelGenerator extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		singleTex(TFItems.SUGAR_FREE_KOBOLD_GUMMY);
		singleTex(TFItems.KOBOLD_GUMMY);

		singleTex(TFItems.KOBOLD_CHUNK_ONE);
		singleTex(TFItems.KOBOLD_CHUNK_TWO);
		singleTex(TFItems.KOBOLD_CHUNK_THREE);
		singleTex(TFItems.KOBOLD_CHUNK_FOUR);
		singleTex(TFItems.KOBOLD_CHUNK_FIVE);
		singleTex(TFItems.KOBOLD_CHUNK_SIX);
		singleTex(TFItems.KOBOLD_CHUNK_SEVEN);
		singleTex(TFItems.KOBOLD_CHUNK_EIGHT);
