...
public class EntityLootTables extends EntityLoot {
	...
	protected void addTables() {
		...
		add(TFEntities.INTERLOPER_BOSS.get(), emptyLootTable());
		...
		add(TFEntities.NAGA.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_EIGHT.get().asItem()))));
		...
		add(TFEntities.LICH.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_SEVEN.get().asItem()))));
		...
		add(TFEntities.MINOSHROOM.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_SIX.get().asItem()))));
		...
		add(TFEntities.HYDRA.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_FIVE.get().asItem()))));
		...
		add(TFEntities.UR_GHAST.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_THREE.get().asItem()))));
		...
		add(TFEntities.ALPHA_YETI.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_TWO.get().asItem()))));
		...
		add(TFEntities.SNOW_QUEEN.get(),
				LootTable.lootTable()
						...
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.KOBOLD_CHUNK_ONE.get().asItem()))));
