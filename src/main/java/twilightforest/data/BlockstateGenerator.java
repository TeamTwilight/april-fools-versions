...
public class BlockstateGenerator extends BlockStateProvider {
	...
	protected void registerStatesAndModels() {
		...
		simpleBlock(TFBlocks.FINAL_BOSS_TROPHY.get(), models().getExistingFile(new ResourceLocation("block/skull")));
		...
		simpleBlock(TFBlocks.FINAL_BOSS_WALL_TROPHY.get(), models().getExistingFile(new ResourceLocation("block/skull")));
