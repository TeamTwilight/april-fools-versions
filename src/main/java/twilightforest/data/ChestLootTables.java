...
public class ChestLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
	...
	public void accept(BiConsumer<ResourceLocation, LootTable.Builder> register) {
		...
		register.accept(TFTreasure.PLATEAU_BOSS.lootTable,
				LootTable.lootTable()
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.CUBE_OF_ANNIHILATION.get()))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.GLASS_SWORD.get()).apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), (nbt) -> nbt.putBoolean("Unbreakable", true)))))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFBlocks.FINAL_BOSS_TROPHY.get().asItem()))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFBlocks.TWILIGHT_PORTAL_MINIATURE_STRUCTURE.get().asItem()))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFBlocks.NAGA_COURTYARD_MINIATURE_STRUCTURE.get().asItem()))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFBlocks.LICH_TOWER_MINIATURE_STRUCTURE.get().asItem()))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.ORE_METER.get()))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.ORE_MAGNET.get()).apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), (nbt) -> nbt.putBoolean("Unbreakable", true)))))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.GIANT_PICKAXE.get()).apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), (nbt) -> nbt.putBoolean("Unbreakable", true)))))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.MOONWORM_QUEEN.get()).apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), (nbt) -> nbt.putBoolean("Unbreakable", true)))))
						)
						.withPool(LootPool.lootPool()
								.setRolls(ConstantValue.exactly(1))
								.add(LootItem.lootTableItem(TFItems.PEACOCK_FEATHER_FAN.get()).apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), (nbt) -> nbt.putBoolean("Unbreakable", true)))))
						));
	}
}
