...
public class BlockLootTables extends net.minecraft.data.loot.BlockLoot {
	...
	protected void addTables() {
		...
		add(TFBlocks.FINAL_BOSS_TROPHY.get(), createSingleItemTable(TFBlocks.FINAL_BOSS_TROPHY.get().asItem()));
		add(TFBlocks.FINAL_BOSS_WALL_TROPHY.get(), createSingleItemTable(TFBlocks.FINAL_BOSS_TROPHY.get().asItem()));
