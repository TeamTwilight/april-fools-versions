...
public class CraftingGenerator extends CraftingDataHelper {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		ShapedRecipeBuilder.shaped(TFItems.KOBOLD_GUMMY.get())
				.pattern("123")
				.pattern("4s5")
				.pattern("678")
				.define('1', Ingredient.of(TFItems.KOBOLD_CHUNK_ONE.get()))
				.define('2', Ingredient.of(TFItems.KOBOLD_CHUNK_TWO.get()))
				.define('3', Ingredient.of(TFItems.KOBOLD_CHUNK_THREE.get()))
				.define('4', Ingredient.of(TFItems.KOBOLD_CHUNK_FOUR.get()))
				.define('5', Ingredient.of(TFItems.KOBOLD_CHUNK_FIVE.get()))
				.define('6', Ingredient.of(TFItems.KOBOLD_CHUNK_SIX.get()))
				.define('7', Ingredient.of(TFItems.KOBOLD_CHUNK_SEVEN.get()))
				.define('8', Ingredient.of(TFItems.KOBOLD_CHUNK_EIGHT.get()))
				.define('s', Ingredient.of(Items.SUGAR))
				.unlockedBy("has_item", has(Items.SUGAR))
				.save(consumer, TwilightForestMod.prefix("kobold_gummy"));

		ShapedRecipeBuilder.shaped(TFItems.SUGAR_FREE_KOBOLD_GUMMY.get())
				.pattern("123")
				.pattern("4 5")
				.pattern("678")
				.define('1', Ingredient.of(TFItems.KOBOLD_CHUNK_ONE.get()))
				...
				.define('7', Ingredient.of(TFItems.KOBOLD_CHUNK_SEVEN.get()))
				.define('8', Ingredient.of(TFItems.KOBOLD_CHUNK_EIGHT.get()))
				.unlockedBy("has_item", has(TFItems.KOBOLD_CHUNK_EIGHT.get()))
				.save(consumer, TwilightForestMod.prefix("sugar_free_kobold_gummy"));
