...
public class TFConfig {
	...
	public static class Client {
		...
		public Client(ForgeConfigSpec.Builder builder) {
			...
			forceOFCompat = builder.
					translation(config + "force_of_compat").
					comment("If true, forces Optifine compat on. Disabling this won't turn the compat off if you actually have optifine installed, like an idiot.").
					define("force_optifine_compat", true);
			builder.
		...
		public ForgeConfigSpec.BooleanValue forceOFCompat;
