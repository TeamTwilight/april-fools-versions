...
public class TwilightForestMod {
	public static String GAME_TITLE = "Minecrat";

	//BIG FAT TODO: RESCALE DIFFICULTY, FIX PROGRESSION RENDERING, tee hee eks dee
	...
	public TwilightForestMod() {
		...
		TFPaintings.REGISTRY.register(modbus);
	...
	public static void addClassicPack(AddPackFindersEvent event) {
		try {
			if (event.getPackType() == PackType.CLIENT_RESOURCES && false) {
