...
public class TFItems {
	...
	public static final RegistryObject<Item> SUGAR_FREE_KOBOLD_GUMMY = ITEMS.register("sugar_free_kobold_gummy", () -> new KoboldGummy(defaultBuilder().food(STROGANOFF).rarity(TwilightForestMod.getRarity())));
	public static final RegistryObject<Item> KOBOLD_GUMMY = ITEMS.register("kobold_gummy", () -> new KoboldGummy(defaultBuilder().food(STROGANOFF).rarity(TwilightForestMod.getRarity())));

	public static final RegistryObject<Item> KOBOLD_CHUNK_ONE = ITEMS.register("kobold_chunk_one", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_TWO = ITEMS.register("kobold_chunk_two", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_THREE = ITEMS.register("kobold_chunk_three", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_FOUR = ITEMS.register("kobold_chunk_four", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_FIVE = ITEMS.register("kobold_chunk_five", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_SIX = ITEMS.register("kobold_chunk_six", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_SEVEN = ITEMS.register("kobold_chunk_seven", () -> new Item(defaultBuilder()));
	public static final RegistryObject<Item> KOBOLD_CHUNK_EIGHT = ITEMS.register("kobold_chunk_eight", () -> new Item(defaultBuilder()));
