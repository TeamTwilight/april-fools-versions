...
public class TFEntities {
	...
	public static final RegistryObject<EntityType<Interloper>> INTERLOPER_BOSS = make(TFEntityNames.INTERLOPER_BOSS, Interloper::new, MobCategory.MONSTER, 1F, 1F, true, 0x372096, 0x895d1b);
	...
	public static void addEntityAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(INTERLOPER_BOSS.get(), Interloper.registerAttributes().build());
	...
	public static void registerEntityRenderer(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(INTERLOPER_BOSS.get(), InterloperRenderer::new);
