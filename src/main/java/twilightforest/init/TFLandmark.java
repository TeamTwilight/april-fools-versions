...
public class TFLandmark implements StructureHints, AdvancementLockedStructure, DecorationClearance, ControlledSpawns {
	...
	public static final TFLandmark NAGA_COURTYARD = new TFLandmark( 3, "naga_courtyard", true, BiomeTagGenerator.VALID_NAGA_COURTYARD_BIOMES, TerrainAdjustment.BEARD_THIN, TwilightForestMod.prefix("progress_lich")) {
		{
			this.enableTerrainAlterations();
	...
	public static final TFLandmark LICH_TOWER = new TFLandmark( 1, "lich_tower", true, BiomeTagGenerator.VALID_LICH_TOWER_BIOMES, TerrainAdjustment.BEARD_THIN, TwilightForestMod.prefix("progress_labyrinth")) {
		{
	...
	public static final TFLandmark HYDRA_LAIR = new TFLandmark( 2, "hydra_lair"    , true, BiomeTagGenerator.VALID_HYDRA_LAIR_BIOMES, TerrainAdjustment.NONE, true, TwilightForestMod.prefix("progress_knights") ) {
		{
			this.enableTerrainAlterations();
			this.undergroundDecoAllowed = false;
		}
	...
	public static final TFLandmark LABYRINTH = new TFLandmark( 3, "labyrinth", true, BiomeTagGenerator.VALID_LABYRINTH_BIOMES, TerrainAdjustment.BURY, TwilightForestMod.prefix("progress_hydra") ) {
		{
	...
	public static final TFLandmark DARK_TOWER = new TFLandmark( 1, "dark_tower", true, BiomeTagGenerator.VALID_DARK_TOWER_BIOMES, TerrainAdjustment.BEARD_THIN, TwilightForestMod.prefix("progress_yeti") ) {
		{
	...
	public static final TFLandmark KNIGHT_STRONGHOLD = new TFLandmark( 3, "knight_stronghold", true, BiomeTagGenerator.VALID_KNIGHT_STRONGHOLD_BIOMES, TerrainAdjustment.BURY, TwilightForestMod.prefix("progress_ur_ghast") ) {
		{
	...
	public static final TFLandmark YETI_CAVE = new TFLandmark( 2, "yeti_lairs", true, BiomeTagGenerator.VALID_YETI_CAVE_BIOMES, TerrainAdjustment.BURY, true, TwilightForestMod.prefix("progress_glacier") ) {
		{
			this.enableDecorations().enableTerrainAlterations();
			this.undergroundDecoAllowed = false;
	...
	public static final TFLandmark ICE_TOWER = new TFLandmark( 2, "ice_tower", true, BiomeTagGenerator.VALID_AURORA_PALACE_BIOMES, TerrainAdjustment.NONE) {
		{
	...
	public static final TFLandmark TROLL_CAVE = new TFLandmark( 4, "troll_lairs", true, BiomeTagGenerator.VALID_TROLL_CAVE_BIOMES, TerrainAdjustment.BURY) {
		{
	...
	public static final TFLandmark FINAL_CASTLE = new TFLandmark( 4, "final_castle", true, BiomeTagGenerator.VALID_FINAL_CASTLE_BIOMES, TerrainAdjustment.BEARD_THIN) {
//		{
