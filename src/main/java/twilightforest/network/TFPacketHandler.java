...
public class TFPacketHandler {
	...
	public static void init() {
		...
		CHANNEL.messageBuilder(ThisIdiotHasOptifinePacket.class, id++).encoder(ThisIdiotHasOptifinePacket::encode).decoder(ThisIdiotHasOptifinePacket::new).consumer(ThisIdiotHasOptifinePacket.Handler::onMessage).add();
	}
}
