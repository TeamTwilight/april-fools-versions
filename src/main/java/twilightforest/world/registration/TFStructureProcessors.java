...
import twilightforest.world.components.structures.reworks.DarkTowerRework;
import twilightforest.world.components.structures.reworks.FinalCastleRework;
import twilightforest.world.components.structures.reworks.MazeRework;
import twilightforest.world.components.structures.reworks.StrongholdRework;
...
public class TFStructureProcessors {
	...
	public static final StructureProcessorType<MazeRework.MazestoneProcessor> MAZESTONE = registerProcessor("mazestone", MazeRework.MazestoneProcessor.CODEC);
	public static final StructureProcessorType<StrongholdRework.StrongholdProcessor> STRONGHOLD = registerProcessor("stronghold", StrongholdRework.StrongholdProcessor.CODEC);
	public static final StructureProcessorType<DarkTowerRework.TowerwoodProcessor> TOWERWOOD = registerProcessor("towerwood", DarkTowerRework.TowerwoodProcessor.CODEC);
	public static final StructureProcessorType<FinalCastleRework.CastleProcessor> CASTLE = registerProcessor("castle", FinalCastleRework.CastleProcessor.CODEC);
