...
import twilightforest.world.components.structures.reworks.*;
...
public class TFFeature {
	...
	public static final TFFeature NAGA_COURTYARD = new TFFeature( 3, "naga_courtyard", true ) {
		...
		@Override
		public StructurePiece provideStructureStart(StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, int x, int y, int z) {
			return new NagaCourtyardRework(structureManager, new BlockPos(x, y, z));
		}
	};
	...
	public static final TFFeature LABYRINTH = new TFFeature( 3, "labyrinth", true, TwilightForestMod.prefix("progress_lich") ) {
		...
		@Override
		public StructurePiece provideStructureStart(StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, int x, int y, int z) {
			return new MazeRework(structureManager, new BlockPos(x, y, z));
		}
	...
	public static final TFFeature DARK_TOWER = new TFFeature( 1, "dark_tower", true, TwilightForestMod.prefix("progress_knights") ) {
		...
		@Override
		public StructurePiece provideStructureStart(StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, int x, int y, int z) {
			return new DarkTowerRework(structureManager, new BlockPos(x - 7, y, z - 7));
		}
	};
	public static final TFFeature KNIGHT_STRONGHOLD = new TFFeature( 3, "knight_stronghold", true, TwilightForestMod.prefix("progress_trophy_pedestal") ) {
		...
		@Override
		public StructurePiece provideStructureStart(StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, int x, int y, int z) {
			return new StrongholdRework(structureManager, new BlockPos(x - 7, y, z - 7));
		}
	...
	public static final TFFeature ICE_TOWER = new TFFeature( 2, "ice_tower", true, TwilightForestMod.prefix("progress_yeti") ) {
		...
		@Override
		public StructurePiece provideStructureStart(StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, int x, int y, int z) {
			return new AuroraPalaceRework(structureManager, new BlockPos(x - 7, y + 32, z - 7));
		}
	};
	...
	public static final TFFeature FINAL_CASTLE = new TFFeature( 4, "final_castle", true, TwilightForestMod.prefix("progress_troll") ) {
		...
		@Override
		public StructurePiece provideStructureStart(StructureManager structureManager, ChunkGenerator chunkGenerator, Random rand, int x, int y, int z) {
			return new FinalCastleRework(structureManager, new BlockPos(x - 7, y + 90, z - 7));
		}
	};
	public static final TFFeature MUSHROOM_TOWER = new TFFeature( 2, "mushroom_tower", true ) {
		{
			this.addMonster(EntityType.MOOSHROOM, 10, 1, 2);
		}
	...
	public static final StructurePieceType ReworkedCourtyard = registerPiece("TFCourtyard", NagaCourtyardRework::new);
	public static final StructurePieceType ReworkedStronghold = registerPiece("TFStronghold", StrongholdRework::new);
	public static final StructurePieceType ReworkedLabyrinth = registerPiece("TFLabyrinth", MazeRework::new);
	public static final StructurePieceType ReworkedDarkTower = registerPiece("TFDarkTower", DarkTowerRework::new);
	public static final StructurePieceType ReworkedPalace = registerPiece("TFPalace", AuroraPalaceRework::new);
	public static final StructurePieceType ReworkedCastle = registerPiece("TFCastle", FinalCastleRework::new);
